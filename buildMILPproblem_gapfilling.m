function bilevelMILPproblem = buildMILPproblem_gapfilling(models, binary_variable_ids, constraints, previousSolutions, penalizedReactions, penalizationFactors)
